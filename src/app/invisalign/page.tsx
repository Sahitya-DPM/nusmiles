        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="text-center lg:text-left">
              <h3 className="text-[22px] md:text-[16px] font-bold text-gray-900 mb-6" style={{ fontFamily: 'Montserrat, Arial, Helvetica, sans-serif' }}>
              ...
              <div className="grid grid-cols-1 gap-4">
                {conditions.map((condition, index) => (
                  <div key={index} className="flex items-center p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <span className="text-[16px] md:text-[16px] font-medium text-gray-900" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                      {condition}
                    </span>
                  </div>
                ))}
