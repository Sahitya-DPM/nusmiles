        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Severe gum pain or tenderness</li>
              <li className="text-gray-700 text-[16px] md:text-base">Swollen, red, or bleeding gums</li>
              <li className="text-gray-700 text-[16px] md:text-base">Gums that are receding or pulling away from teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Pus or discharge from gums</li>
              <li className="text-gray-700 text-[16px] md:text-base">Loose teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Bad breath that doesn't improve with brushing</li>
              <li className="text-gray-700 text-[16px] md:text-base">Fever or general feeling of illness</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              ...
              <li className="text-gray-700 text-[16px] md:text-base">Excessive bleeding that doesn't stop</li>
              <li className="text-gray-700 text-[16px] md:text-base">Signs of infection (pus, fever, swelling)</li>
              <li className="text-gray-700 text-[16px] md:text-base">Loose teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Difficulty breathing or swallowing</li>
              <li className="text-gray-700 text-[16px] md:text-base">Facial swelling</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              ...
              <li className="text-gray-700 text-[16px] md:text-base">Use a soft-bristled toothbrush and gentle brushing technique</li>
              <li className="text-gray-700 text-[16px] md:text-base">Avoid tobacco products</li>
              <li className="text-gray-700 text-[16px] md:text-base">Eat a balanced diet rich in vitamins and minerals</li>
              <li className="text-gray-700 text-[16px] md:text-base">Manage stress levels</li>
            </ul>
