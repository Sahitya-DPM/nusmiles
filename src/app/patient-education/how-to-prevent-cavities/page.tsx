          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Dairy products like cheese, milk, and yogurt (they contain calcium and phosphates)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Crunchy fruits and vegetables (they help clean teeth naturally)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Nuts and seeds (they provide minerals that strengthen teeth)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Green and black teas (they contain compounds that suppress harmful bacteria)</li>
              </ul>
            ...
            <div className="bg-green-50 rounded-xl p-8 mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Tooth sensitivity to hot, cold, or sweet foods</li>
                <li className="text-gray-700 text-[16px] md:text-base">Visible holes or pits in your teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Brown, black, or white staining on tooth surfaces</li>
                <li className="text-gray-700 text-[16px] md:text-base">Pain when biting down</li>
                <li className="text-gray-700 text-[16px] md:text-base">Spontaneous toothache</li>
              </ul>
              <p className="text-lg md:text-[16px] leading-relaxed text-gray-700 mt-4" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
