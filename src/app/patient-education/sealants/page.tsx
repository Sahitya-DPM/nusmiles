          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Children and teenagers (ages 6-14)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Adults with deep grooves in their teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">People at high risk for cavities</li>
                <li className="text-gray-700 text-[16px] md:text-base">Those with a history of tooth decay</li>
                <li className="text-gray-700 text-[16px] md:text-base">Individuals with difficulty maintaining good oral hygiene</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ol className="list-decimal pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">The tooth is thoroughly cleaned and dried</li>
                <li className="text-gray-700 text-[16px] md:text-base">An acidic solution is applied to roughen the surface for better bonding</li>
                <li className="text-gray-700 text-[16px] md:text-base">The tooth is rinsed and dried again</li>
                <li className="text-gray-700 text-[16px] md:text-base">The sealant material is applied to the chewing surface</li>
                <li className="text-gray-700 text-[16px] md:text-base">A special light is used to harden the sealant</li>
                <li className="text-gray-700 text-[16px] md:text-base">The dentist checks the bite and makes any necessary adjustments</li>
              </ol>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Reduce the risk of cavities by up to 80%</li>
                <li className="text-gray-700 text-[16px] md:text-base">Protect teeth during the cavity-prone years</li>
                <li className="text-gray-700 text-[16px] md:text-base">Cost-effective preventive treatment</li>
                <li className="text-gray-700 text-[16px] md:text-base">Painless and non-invasive procedure</li>
                <li className="text-gray-700 text-[16px] md:text-base">Long-lasting protection (can last 5-10 years)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Easy to maintain with regular dental care</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Continue brushing twice daily with fluoride toothpaste</li>
                <li className="text-gray-700 text-[16px] md:text-base">Floss daily to clean between teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Visit your dentist regularly for checkups</li>
                <li className="text-gray-700 text-[16px] md:text-base">Avoid chewing on hard objects that could damage sealants</li>
                <li className="text-gray-700 text-[16px] md:text-base">Have sealants checked during dental visits</li>
              </ul>
            </div>
