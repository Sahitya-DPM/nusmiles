          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Hold your toothbrush at a 45-degree angle to your gums</li>
                <li className="text-gray-700 text-[16px] md:text-base">Use gentle, circular motions to clean all surfaces of your teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Brush the outer surfaces, inner surfaces, and chewing surfaces</li>
                <li className="text-gray-700 text-[16px] md:text-base">Don't forget to brush your tongue to remove bacteria and freshen breath</li>
                <li className="text-gray-700 text-[16px] md:text-base">Brush for at least two minutes, twice daily</li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Use about 18 inches of floss, wrapping most around your middle fingers</li>
                <li className="text-gray-700 text-[16px] md:text-base">Hold the floss tightly between your thumbs and index fingers</li>
                <li className="text-gray-700 text-[16px] md:text-base">Gently guide the floss between your teeth using a sawing motion</li>
                <li className="text-gray-700 text-[16px] md:text-base">Curve the floss around each tooth in a C shape</li>
                <li className="text-gray-700 text-[16px] md:text-base">Slide the floss up and down against the tooth surface and under the gumline</li>
                <li className="text-gray-700 text-[16px] md:text-base">Use a fresh section of floss for each tooth</li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Brushing too hard, which can damage gums and enamel</li>
                <li className="text-gray-700 text-[16px] md:text-base">Not brushing long enough (aim for at least 2 minutes)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Skipping the gumline when brushing</li>
                <li className="text-gray-700 text-[16px] md:text-base">Snapping floss between teeth, which can injure gums</li>
                <li className="text-gray-700 text-[16px] md:text-base">Not flossing every day</li>
                <li className="text-gray-700 text-[16px] md:text-base">Forgetting to brush your tongue</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Use fluoride toothpaste to strengthen enamel</li>
                <li className="text-gray-700 text-[16px] md:text-base">Consider using an antimicrobial mouthwash</li>
                <li className="text-gray-700 text-[16px] md:text-base">Drink plenty of water to help wash away food particles</li>
                <li className="text-gray-700 text-[16px] md:text-base">Limit sugary and acidic foods and beverages</li>
                <li className="text-gray-700 text-[16px] md:text-base">Visit your dentist regularly for check-ups and cleanings</li>
              </ul>
            </div>
            ...
            <div className="bg-blue-50 rounded-xl p-8 mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Bleeding gums that persist after proper brushing and flossing</li>
                <li className="text-gray-700 text-[16px] md:text-base">Persistent bad breath</li>
                <li className="text-gray-700 text-[16px] md:text-base">Tooth sensitivity or pain</li>
                <li className="text-gray-700 text-[16px] md:text-base">Loose teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Changes in the way your teeth fit together</li>
              </ul>
            </div>
          </div>
        </div>
