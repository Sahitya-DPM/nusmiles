        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Dental cavities and decay</li>
              <li className="text-gray-700 text-[16px] md:text-base">Tooth abscess or infection</li>
              <li className="text-gray-700 text-[16px] md:text-base">Cracked or broken teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Gum disease</li>
              <li className="text-gray-700 text-[16px] md:text-base">Exposed tooth roots</li>
              <li className="text-gray-700 text-[16px] md:text-base">Loose or damaged fillings</li>
              <li className="text-gray-700 text-[16px] md:text-base">Sinus infections (referred pain)</li>
              <li className="text-gray-700 text-[16px] md:text-base">Temporomandibular joint (TMJ) disorders</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Severe pain that doesn't respond to over-the-counter pain relievers</li>
              <li className="text-gray-700 text-[16px] md:text-base">Pain accompanied by fever or swelling</li>
              <li className="text-gray-700 text-[16px] md:text-base">Pain that lasts more than 1-2 days</li>
              <li className="text-gray-700 text-[16px] md:text-base">Difficulty breathing or swallowing</li>
              <li className="text-gray-700 text-[16px] md:text-base">Pain that radiates to your ear, jaw, or neck</li>
              <li className="text-gray-700 text-[16px] md:text-base">Signs of infection (pus, bad taste, swollen lymph nodes)</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              ...
              <li className="text-gray-700 text-[16px] md:text-base">Visit your dentist regularly for checkups and cleanings</li>
              <li className="text-gray-700 text-[16px] md:text-base">Use fluoride toothpaste and consider fluoride treatments</li>
              <li className="text-gray-700 text-[16px] md:text-base">Limit sugary foods and beverages</li>
              <li className="text-gray-700 text-[16px] md:text-base">Wear a mouthguard during sports or if you grind your teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Address dental issues promptly before they worsen</li>
            </ul>
