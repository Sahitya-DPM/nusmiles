          ...
          <div className="flex flex-wrap justify-center mb-8 md:mb-12">
            {oralHealthCategories.map((category) => (
              <button
                ...
                className={`px-4 md:px-6 py-2 md:py-3 mx-1 md:mx-2 mb-2 rounded-lg font-semibold transition-all duration-300 text-[15px] md:text-base ${
                ...
                {category.articles.map((article, index) => (
                  <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div className="p-4 md:p-6">
                      ...
                      <h3 className="text-[22px] md:text-[16px] font-bold text-gray-900 mb-3" style={{ fontFamily: 'Montserrat, Arial, Helvetica, sans-serif', lineHeight: '1.4' }}>
                        {article.title}
                      </h3>
