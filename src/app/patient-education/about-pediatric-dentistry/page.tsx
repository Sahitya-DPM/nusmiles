          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Child psychology and behavior management</li>
                <li className="text-gray-700 text-[16px] md:text-base">Growth and development of children's teeth and jaws</li>
                <li className="text-gray-700 text-[16px] md:text-base">Preventive dental care for children</li>
                <li className="text-gray-700 text-[16px] md:text-base">Treatment of dental injuries and emergencies</li>
                <li className="text-gray-700 text-[16px] md:text-base">Care for children with special needs</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Comprehensive oral health examinations</li>
                <li className="text-gray-700 text-[16px] md:text-base">Preventive dental care and cleanings</li>
                <li className="text-gray-700 text-[16px] md:text-base">Fluoride treatments and sealants</li>
                <li className="text-gray-700 text-[16px] md:text-base">Cavity fillings and restorations</li>
                <li className="text-gray-700 text-[16px] md:text-base">Emergency dental care</li>
                <li className="text-gray-700 text-[16px] md:text-base">Orthodontic evaluations</li>
                <li className="text-gray-700 text-[16px] md:text-base">Habit counseling (thumb sucking, pacifier use)</li>
              </ul>
            </div>
