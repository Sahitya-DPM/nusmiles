          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Anxiety reduction:</strong> Creates a feeling of calmness and relaxation</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Pain relief:</strong> Provides mild pain relief and reduces sensitivity</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Time distortion:</strong> Makes the procedure seem shorter than it actually is</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Euphoria:</strong> Produces a pleasant, happy feeling</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Cooperation:</strong> Helps children remain still and cooperative</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Experience anxiety or fear about dental procedures</li>
                <li className="text-gray-700 text-[16px] md:text-base">Have difficulty sitting still for extended periods</li>
                <li className="text-gray-700 text-[16px] md:text-base">Have a strong gag reflex</li>
                <li className="text-gray-700 text-[16px] md:text-base">Need multiple procedures in one visit</li>
                <li className="text-gray-700 text-[16px] md:text-base">Have special needs that make dental treatment challenging</li>
                <li className="text-gray-700 text-[16px] md:text-base">Are undergoing procedures that may cause discomfort</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ol className="list-decimal pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">The child is seated comfortably in the dental chair</li>
                <li className="text-gray-700 text-[16px] md:text-base">A small, comfortable mask is placed over the nose</li>
                <li className="text-gray-700 text-[16px] md:text-base">The child breathes normally through the nose</li>
                <li className="text-gray-700 text-[16px] md:text-base">Nitrous oxide and oxygen are gradually introduced</li>
                <li className="text-gray-700 text-[16px] md:text-base">The child begins to feel relaxed and comfortable</li>
                <li className="text-gray-700 text-[16px] md:text-base">The dental procedure is performed</li>
                <li className="text-gray-700 text-[16px] md:text-base">Pure oxygen is given to clear the nitrous oxide</li>
                <li className="text-gray-700 text-[16px] md:text-base">The child returns to normal within minutes</li>
              </ol>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Mild side effects:</strong> May include lightheadedness, tingling in hands and feet, or mild nausea</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Rare reactions:</strong> Some children may not respond well to nitrous oxide</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Medical conditions:</strong> Children with certain medical conditions may not be candidates</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Allergies:</strong> Very rare allergic reactions can occur</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Recovery:</strong> Effects wear off quickly, usually within 5-10 minutes</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Explain the process in simple, positive terms</li>
                <li className="text-gray-700 text-[16px] md:text-base">Avoid eating a heavy meal 2-3 hours before the appointment</li>
                <li className="text-gray-700 text-[16px] md:text-base">Ensure your child is well-rested</li>
                <li className="text-gray-700 text-[16px] md:text-base">Dress your child in comfortable clothing</li>
                <li className="text-gray-700 text-[16px] md:text-base">Arrive on time to avoid rushing and stress</li>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Safe and well-tolerated by most children</li>
                <li className="text-gray-700 text-[16px] md:text-base">Quick onset and recovery</li>
                <li className="text-gray-700 text-[16px] md:text-base">No needles or injections required</li>
                <li className="text-gray-700 text-[16px] md:text-base">Children remain conscious and responsive</li>
                <li className="text-gray-700 text-[16px] md:text-base">Helps create positive dental experiences</li>
                <li className="text-gray-700 text-[16px] md:text-base">Reduces the need for more invasive sedation</li>
                <li className="text-gray-700 text-[16px] md:text-base">Cost-effective sedation option</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Children can usually return to normal activities immediately</li>
                <li className="text-gray-700 text-[16px] md:text-base">No special dietary restrictions</li>
                <li className="text-gray-700 text-[16px] md:text-base">Effects wear off completely within minutes</li>
                <li className="text-gray-700 text-[16px] md:text-base">Children often report feeling happy and relaxed</li>
                <li className="text-gray-700 text-[16px] md:text-base">No memory impairment or confusion</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Oral sedation medications</li>
                <li className="text-gray-700 text-[16px] md:text-base">IV sedation for more complex procedures</li>
                <li className="text-gray-700 text-[16px] md:text-base">General anesthesia for extensive treatment</li>
                <li className="text-gray-700 text-[16px] md:text-base">Behavioral techniques and distraction methods</li>
              </ul>
              <p className="text-[16px] md:text-lg leading-relaxed text-gray-700 mb-4" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
