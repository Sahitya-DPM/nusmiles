        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              ...
              <li className="text-gray-700 text-[16px] md:text-base">Broken wires that are causing cuts or bleeding</li>
              <li className="text-gray-700 text-[16px] md:text-base">Loose brackets that are causing significant discomfort</li>
              <li className="text-gray-700 text-[16px] md:text-base">Lost aligners that cannot be replaced immediately</li>
              <li className="text-gray-700 text-[16px] md:text-base">Signs of infection around orthodontic appliances</li>
              <li className="text-gray-700 text-[16px] md:text-base">Difficulty eating or speaking due to orthodontic issues</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Avoid hard, sticky, or chewy foods that can damage appliances</li>
              <li className="text-gray-700 text-[16px] md:text-base">Wear a mouthguard during sports or physical activities</li>
              <li className="text-gray-700 text-[16px] md:text-base">Follow your orthodontist's care instructions carefully</li>
              <li className="text-gray-700 text-[16px] md:text-base">Keep your aligners in their case when not wearing them</li>
              <li className="text-gray-700 text-[16px] md:text-base">Attend all scheduled appointments</li>
              <li className="text-gray-700 text-[16px] md:text-base">Maintain good oral hygiene to prevent complications</li>
            </ul>
