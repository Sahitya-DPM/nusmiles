          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Fluoridated drinking water</li>
                <li className="text-gray-700 text-[16px] md:text-base">Fluoride toothpaste (age-appropriate)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Professional fluoride treatments at dental visits</li>
                <li className="text-gray-700 text-[16px] md:text-base">Fluoride supplements (if prescribed by a dentist)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Some foods and beverages</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Birth to 3 years:</strong> Use a tiny smear of fluoride toothpaste (about the size of a grain of rice) twice daily</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>3-6 years:</strong> Use a pea-sized amount of fluoride toothpaste twice daily</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>6+ years:</strong> Continue with pea-sized amount and ensure proper brushing technique</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Use only the recommended amount of toothpaste</li>
                <li className="text-gray-700 text-[16px] md:text-base">Supervise young children during brushing to prevent swallowing</li>
                <li className="text-gray-700 text-[16px] md:text-base">Store fluoride products out of reach of children</li>
                <li className="text-gray-700 text-[16px] md:text-base">Follow your dentist's recommendations for fluoride supplements</li>
                <li className="text-gray-700 text-[16px] md:text-base">Be aware of your local water fluoridation status</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                ...
                <li className="text-gray-700 text-[16px] md:text-base">Weakened tooth enamel</li>
                <li className="text-gray-700 text-[16px] md:text-base">Increased sensitivity to hot and cold</li>
                <li className="text-gray-700 text-[16px] md:text-base">More frequent dental problems</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Age and developmental stage</li>
                <li className="text-gray-700 text-[16px] md:text-base">Risk of cavities</li>
                <li className="text-gray-700 text-[16px] md:text-base">Local water fluoridation</li>
                <li className="text-gray-700 text-[16px] md:text-base">Diet and oral hygiene habits</li>
                <li className="text-gray-700 text-[16px] md:text-base">Medical history</li>
              </ul>
            </div>
          </div>
        </div>
