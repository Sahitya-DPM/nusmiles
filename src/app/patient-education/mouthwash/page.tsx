          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Temporarily freshens breath</li>
                <li className="text-gray-700 text-[16px] md:text-base">Provides pleasant taste</li>
                <li className="text-gray-700 text-[16px] md:text-base">Does not kill bacteria</li>
                <li className="text-gray-700 text-[16px] md:text-base">No therapeutic benefits</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Kills bacteria that cause bad breath and gum disease</li>
                <li className="text-gray-700 text-[16px] md:text-base">Reduces plaque and gingivitis</li>
                <li className="text-gray-700 text-[16px] md:text-base">Contains active ingredients like fluoride, chlorhexidine, or essential oils</li>
                <li className="text-gray-700 text-[16px] md:text-base">Provides long-term benefits</li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Freshens breath and provides a clean feeling</li>
                <li className="text-gray-700 text-[16px] md:text-base">Reduces bacteria that cause bad breath and gum disease</li>
                <li className="text-gray-700 text-[16px] md:text-base">Helps prevent cavities (fluoride mouthwash)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Reduces plaque and gingivitis</li>
                <li className="text-gray-700 text-[16px] md:text-base">Reaches areas that brushing and flossing may miss</li>
                <li className="text-gray-700 text-[16px] md:text-base">Can help with dry mouth symptoms</li>
                <li className="text-gray-700 text-[16px] md:text-base">Provides additional protection against oral health problems</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ol className="list-decimal pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Brush and floss your teeth first</li>
                <li className="text-gray-700 text-[16px] md:text-base">Pour the recommended amount of mouthwash (usually 20ml or 4 teaspoons)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Rinse your mouth thoroughly for 30-60 seconds</li>
                <li className="text-gray-700 text-[16px] md:text-base">Spit out the mouthwash (do not swallow)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Avoid eating or drinking for 30 minutes after use</li>
              </ol>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Always read and follow the product instructions</li>
                <li className="text-gray-700 text-[16px] md:text-base">Use mouthwash as a supplement, not a replacement for brushing and flossing</li>
                <li className="text-gray-700 text-[16px] md:text-base">Don't use mouthwash immediately after brushing with fluoride toothpaste</li>
                <li className="text-gray-700 text-[16px] md:text-base">Keep mouthwash out of reach of children</li>
                <li className="text-gray-700 text-[16px] md:text-base">Store mouthwash in a cool, dry place</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Bad breath: Look for antiseptic mouthwash</li>
                <li className="text-gray-700 text-[16px] md:text-base">Cavity prevention: Choose fluoride mouthwash</li>
                <li className="text-gray-700 text-[16px] md:text-base">Gum disease: Consider antiseptic or therapeutic mouthwash</li>
                <li className="text-gray-700 text-[16px] md:text-base">Sensitive teeth: Look for alcohol-free options</li>
                <li className="text-gray-700 text-[16px] md:text-base">Dry mouth: Choose alcohol-free, moisturizing mouthwash</li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Temporary burning or stinging sensation</li>
                <li className="text-gray-700 text-[16px] md:text-base">Dry mouth (with alcohol-based mouthwashes)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Temporary staining of teeth (with some antiseptic mouthwashes)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Altered taste sensation</li>
                <li className="text-gray-700 text-[16px] md:text-base">Allergic reactions (rare)</li>
              </ul>
              <p className="text-[16px] md:text-[16px] leading-relaxed text-gray-700 mb-4" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
            ...
            <div className="bg-green-50 rounded-xl p-8 mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">After brushing and flossing for additional protection</li>
                <li className="text-gray-700 text-[16px] md:text-base">Between meals to freshen breath</li>
                <li className="text-gray-700 text-[16px] md:text-base">When you can't brush your teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">As directed by your dentist for specific conditions</li>
              </ul>
            </div>
          </div>
        </div>
