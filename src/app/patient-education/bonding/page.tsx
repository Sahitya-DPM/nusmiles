      ...
      <section className="py-10 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <div className="mb-8">
              <span className="inline-block bg-primary/10 text-primary px-4 py-2 rounded-full text-[16px] font-semibold mb-4" style={{ fontFamily: 'Montserrat, Arial, Helvetica, sans-serif' }}>
                Cosmetic & General Dentistry
              </span>
            </div>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Repairing chips and minor cracks</li>
              <li className="text-gray-700 text-[16px] md:text-base">Covering stained or discolored enamel</li>
              <li className="text-gray-700 text-[16px] md:text-base">Closing small gaps between teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Remodeling the contours of teeth that are undersized, crooked, or misshapen</li>
              <li className="text-gray-700 text-[16px] md:text-base">Rebuilding areas where enamel erosion has taken place</li>
              <li className="text-gray-700 text-[16px] md:text-base">Creating inconspicuous, tooth-colored fillings</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Bonding can frequently be completed in one visit, and often without the use of anesthetic</li>
              <li className="text-gray-700 text-[16px] md:text-base">Bonding is less expensive than veneers or crowns</li>
              <li className="text-gray-700 text-[16px] md:text-base">While veneers and crowns last longer and are less vulnerable to chipping or staining, these procedures require the removal of more tooth structure</li>
            </ul>

            <div className="bg-blue-50 border-l-4 border-primary p-6 my-8 rounded-r-lg">
              <h4 className="text-[16px] md:text-[16px] font-bold text-gray-900 mb-2" style={{ fontFamily: 'Montserrat, Arial, Helvetica, sans-serif' }}>
                Important Note
              </h4>
              <p className="text-gray-700 text-[16px]" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
