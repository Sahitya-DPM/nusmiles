        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Sensitivity to hot and cold temperatures</li>
              <li className="text-gray-700 text-[16px] md:text-base">Sensitivity to pressure</li>
              <li className="text-gray-700 text-[16px] md:text-base">Slight discomfort when biting</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              ...
              <li className="text-gray-700 text-[16px] md:text-base">Consider using a fluoride mouthwash</li>
            </ul>
