        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Teeth that are discolored â€” either because of root canal treatment; stains from tetracycline or other drugs, excessive fluoride or other causes; or the presence of large resin fillings that have discolored the tooth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Teeth that are worn down</li>
              <li className="text-gray-700 text-[16px] md:text-base">Teeth that are chipped or broken</li>
              <li className="text-gray-700 text-[16px] md:text-base">Teeth that are misaligned, uneven, or irregularly shaped (for example, have craters or bulges in them)</li>
              <li className="text-gray-700 text-[16px] md:text-base">Teeth with gaps between them (to close the space between these teeth)</li>
            </ul>
            ...
            <p className="text-[16px] md:text-[16px] leading-relaxed text-gray-700 mb-6" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              Getting a dental veneer usually requires three trips to the dentist â€“ one for a consultation and two to make and apply the veneers. One tooth or many teeth can simultaneously undergo the veneering process described below.
            </p>
            ...
            <p className="text-[16px] md:text-[16px] leading-relaxed text-gray-700 mb-6" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              Next, to prepare your tooth to receive the veneer, your tooth will be cleaned, polished, and etched â€” which roughens the tooth to allow for a strong bonding process. A special cement is applied to the veneer and the veneer is then placed on your tooth. Once properly position on the tooth, your dentist will apply a special light beam to the dental veneer, which activates chemicals in the cement, causing it to harden or cure very quickly.
            </p>
