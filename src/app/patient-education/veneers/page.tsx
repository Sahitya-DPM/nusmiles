        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Teeth that are discolored — either because of root canal treatment; stains from tetracycline or other drugs, excessive fluoride or other causes; or the presence of large resin fillings that have discolored the tooth</li>
