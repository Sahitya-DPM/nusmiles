        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Deep decay has reached the pulp</li>
              <li className="text-gray-700 text-[16px] md:text-base">A tooth has been cracked or chipped, exposing the pulp</li>
              <li className="text-gray-700 text-[16px] md:text-base">Repeated dental procedures have damaged the pulp</li>
              <li className="text-gray-700 text-[16px] md:text-base">Trauma to the tooth has caused pulp damage</li>
              <li className="text-gray-700 text-[16px] md:text-base">Severe tooth pain, especially when chewing or applying pressure</li>
              <li className="text-gray-700 text-[16px] md:text-base">Prolonged sensitivity to hot or cold temperatures</li>
              <li className="text-gray-700 text-[16px] md:text-base">Darkening or discoloration of the tooth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Swelling and tenderness in nearby gums</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Mild discomfort for a few days, which can be managed with over-the-counter pain relievers</li>
              <li className="text-gray-700 text-[16px] md:text-base">Sensitivity to pressure for a short time</li>
              <li className="text-gray-700 text-[16px] md:text-base">A temporary filling that will be replaced with a permanent restoration</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">You'll need to return for a permanent restoration (crown or filling)</li>
              <li className="text-gray-700 text-[16px] md:text-base">Maintain good oral hygiene with regular brushing and flossing</li>
              <li className="text-gray-700 text-[16px] md:text-base">Attend regular dental checkups to monitor the treated tooth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Avoid chewing on the treated tooth until it's fully restored</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Saves your natural tooth from extraction</li>
              <li className="text-gray-700 text-[16px] md:text-base">Relieves pain and eliminates infection</li>
              <li className="text-gray-700 text-[16px] md:text-base">Maintains normal biting force and sensation</li>
              <li className="text-gray-700 text-[16px] md:text-base">Prevents damage to surrounding teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">More cost-effective than tooth replacement</li>
              <li className="text-gray-700 text-[16px] md:text-base">Maintains your natural smile</li>
            </ul>
