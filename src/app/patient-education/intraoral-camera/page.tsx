          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Camera Head:</strong> Small, lightweight camera that fits comfortably in the mouth</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Light Source:</strong> Built-in LED lighting for optimal illumination</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Digital Sensor:</strong> High-resolution sensor for crisp, clear images</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Computer Interface:</strong> Software for image capture and storage</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Display Monitor:</strong> Large screen for viewing images</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Enhanced Diagnosis:</strong> Detailed views reveal problems not visible to the naked eye</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Patient Education:</strong> Patients can see exactly what the dentist sees</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Treatment Planning:</strong> Better visualization aids in developing treatment strategies</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Documentation:</strong> Digital images provide permanent records of oral conditions</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Insurance Claims:</strong> Clear images support insurance documentation</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Progress Tracking:</strong> Before-and-after images show treatment results</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Comfort:</strong> Non-invasive and comfortable for patients</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Early signs of tooth decay and cavities</li>
                <li className="text-gray-700 text-[16px] md:text-base">Cracked or fractured teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Worn dental restorations</li>
                <li className="text-gray-700 text-[16px] md:text-base">Gum disease and inflammation</li>
                <li className="text-gray-700 text-[16px] md:text-base">Oral lesions or abnormalities</li>
                <li className="text-gray-700 text-[16px] md:text-base">Tooth wear and erosion</li>
                <li className="text-gray-700 text-[16px] md:text-base">Dental staining and discoloration</li>
                <li className="text-gray-700 text-[16px] md:text-base">Orthodontic issues and tooth alignment</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ol className="list-decimal pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">The dentist gently places the camera in your mouth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Images are captured and displayed on a monitor</li>
                <li className="text-gray-700 text-[16px] md:text-base">You can view the images alongside your dentist</li>
                <li className="text-gray-700 text-[16px] md:text-base">The dentist explains what they see and any concerns</li>
                <li className="text-gray-700 text-[16px] md:text-base">Images are saved to your digital dental record</li>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Visual confirmation of dental problems</li>
                <li className="text-gray-700 text-[16px] md:text-base">Better understanding of treatment needs</li>
                <li className="text-gray-700 text-[16px] md:text-base">Increased motivation for oral hygiene</li>
                <li className="text-gray-700 text-[16px] md:text-base">Clearer explanation of procedures</li>
                <li className="text-gray-700 text-[16px] md:text-base">Documentation of treatment progress</li>
                <li className="text-gray-700 text-[16px] md:text-base">Enhanced communication between patient and dentist</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Images are stored in your digital dental record</li>
                <li className="text-gray-700 text-[16px] md:text-base">Easy comparison with previous visits</li>
                <li className="text-gray-700 text-[16px] md:text-base">Secure, HIPAA-compliant storage</li>
                <li className="text-gray-700 text-[16px] md:text-base">Images can be shared with specialists if needed</li>
                <li className="text-gray-700 text-[16px] md:text-base">Backup and archiving for long-term records</li>
                <li className="text-gray-700 text-[16px] md:text-base">Integration with treatment planning software</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                ...
                <li className="text-gray-700 text-[16px] md:text-base">Non-invasive procedure</li>
                <li className="text-gray-700 text-[16px] md:text-base">Small, comfortable camera design</li>
                <li className="text-gray-700 text-[16px] md:text-base">Quick examination process</li>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                ...
                <li className="text-gray-700 text-[16px] md:text-base">Emergency dental visits</li>
                <li className="text-gray-700 text-[16px] md:text-base">Treatment planning consultations</li>
                <li className="text-gray-700 text-[16px] md:text-base">Follow-up appointments</li>
                <li className="text-gray-700 text-[16px] md:text-base">Orthodontic evaluations</li>
                <li className="text-gray-700 text-[16px] md:text-base">Cosmetic dentistry consultations</li>
                <li className="text-gray-700 text-[16px] md:text-base">Periodontal assessments</li>
              </ul>
            </div>
          </div>
        </div>
