          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-8 rounded-r-lg">
              ...
              <p className="text-blue-700" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                Regular dental visits and proper oral hygiene are essential for maintaining good oral health as you age. Don't let age-related changes compromise your dental wellness.
              </p>
            </div>
          </div>
        </div>
