          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Strengthens tooth enamel</li>
                <li className="text-gray-700 text-[16px] md:text-base">Prevents cavities</li>
                <li className="text-gray-700 text-[16px] md:text-base">Remineralizes early decay</li>
                <li className="text-gray-700 text-[16px] md:text-base">Recommended by dental associations worldwide</li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Cavity prevention: Fluoride toothpaste</li>
                <li className="text-gray-700 text-[16px] md:text-base">Sensitive teeth: Sensitivity toothpaste</li>
                <li className="text-gray-700 text-[16px] md:text-base">Stain removal: Whitening toothpaste</li>
                <li className="text-gray-700 text-[16px] md:text-base">Natural preferences: Natural toothpaste</li>
                <li className="text-gray-700 text-[16px] md:text-base">Children: Age-appropriate children's toothpaste</li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Adults: Pea-sized amount</li>
                <li className="text-gray-700 text-[16px] md:text-base">Children under 3: Rice grain-sized amount</li>
                <li className="text-gray-700 text-[16px] md:text-base">Children 3-6: Pea-sized amount with supervision</li>
                <li className="text-gray-700 text-[16px] md:text-base">More toothpaste doesn't mean better cleaning</li>
              </ul>
            ...
            <div className="bg-blue-50 rounded-xl p-8 mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">When it expires (check the expiration date)</li>
                <li className="text-gray-700 text-[16px] md:text-base">If it has an unusual taste or smell</li>
                <li className="text-gray-700 text-[16px] md:text-base">If it has dried out or changed consistency</li>
                <li className="text-gray-700 text-[16px] md:text-base">Every 3-6 months as a general guideline</li>
                <li className="text-gray-700 text-[16px] md:text-base">If you've been sick (to prevent reinfection)</li>
              </ul>
            </div>
          </div>
        </div>
