        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Strengthen and protect a tooth if extensive decay hasn't left enough healthy tooth structure for a traditional filling</li>
              <li className="text-gray-700 text-[16px] md:text-base">Protect a cracked, broken, or brittle tooth from further damage</li>
              <li className="text-gray-700 text-[16px] md:text-base">Restore and reinforce a tooth after a root canal procedure</li>
              <li className="text-gray-700 text-[16px] md:text-base">Cover a deeply discolored or irregularly shaped tooth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Complete a dental implant procedure</li>
              <li className="text-gray-700 text-[16px] md:text-base">Serve as an anchor for a dental bridge</li>
            </ul>
