          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>6-8 weeks:</strong> Formation of tooth buds begins</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>3-4 months:</strong> Enamel formation starts for primary teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>4-6 months:</strong> Mineralization of primary teeth begins</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>6-8 months:</strong> Development of permanent tooth buds</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Birth:</strong> All primary teeth and first permanent molars are developing</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Calcium:</strong> Essential for strong tooth structure and enamel formation</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Phosphorus:</strong> Works with calcium to build strong teeth and bones</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Vitamin D:</strong> Helps the body absorb calcium and is crucial for tooth mineralization</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Protein:</strong> Provides the building blocks for tooth development</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Vitamin A:</strong> Important for enamel formation and tooth development</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Folate:</strong> Essential for proper cell division and development</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Nutritional status:</strong> Poor nutrition can lead to enamel defects and weaker teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Maternal illness:</strong> Certain infections and illnesses can affect tooth development</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Medications:</strong> Some medications taken during pregnancy can impact dental development</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Stress:</strong> High stress levels may affect nutrient absorption and fetal development</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Smoking and alcohol:</strong> Can cause developmental issues including dental problems</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Enamel hypoplasia:</strong> Thin or missing enamel due to developmental disturbances</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Discolored teeth:</strong> Teeth may appear yellow, brown, or gray due to developmental issues</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Pitted or grooved enamel:</strong> Surface irregularities that can make teeth more susceptible to decay</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Delayed eruption:</strong> Teeth may emerge later than expected</li>
                <li className="text-gray-700 text-[16px] md:text-base"><strong>Missing teeth:</strong> Some teeth may not develop at all</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Maintain a balanced diet rich in calcium, phosphorus, and vitamins</li>
                <li className="text-gray-700 text-[16px] md:text-base">Take prenatal vitamins as recommended by healthcare providers</li>
                <li className="text-gray-700 text-[16px] md:text-base">Attend regular prenatal checkups</li>
                <li className="text-gray-700 text-[16px] md:text-base">Practice good oral hygiene to prevent infections</li>
                <li className="text-gray-700 text-[16px] md:text-base">Avoid smoking, alcohol, and recreational drugs</li>
                <li className="text-gray-700 text-[16px] md:text-base">Manage stress through healthy coping mechanisms</li>
                <li className="text-gray-700 text-[16px] md:text-base">Discuss any medications with healthcare providers</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Breastfeeding provides optimal nutrition for continued dental development</li>
                <li className="text-gray-700 text-[16px] md:text-base">Proper weaning practices help establish good oral habits</li>
                <li className="text-gray-700 text-[16px] md:text-base">Early introduction to dental care sets the foundation for lifelong oral health</li>
                <li className="text-gray-700 text-[16px] md:text-base">Regular dental checkups should begin by the child's first birthday</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Discuss any concerns about dental development with your obstetrician</li>
                <li className="text-gray-700 text-[16px] md:text-base">Consult with a pediatric dentist about early dental care</li>
                <li className="text-gray-700 text-[16px] md:text-base">Follow recommendations for prenatal and postnatal nutrition</li>
                <li className="text-gray-700 text-[16px] md:text-base">Address any maternal health issues that could affect fetal development</li>
              </ul>
            </div>
          </div>
        </div>
