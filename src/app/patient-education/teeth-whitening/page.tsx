        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Food and beverages (coffee, tea, red wine, dark-colored foods)</li>
              <li className="text-gray-700 text-[16px] md:text-base">Tobacco use (smoking or chewing)</li>
              <li className="text-gray-700 text-[16px] md:text-base">Poor dental hygiene</li>
              <li className="text-gray-700 text-[16px] md:text-base">Age-related changes</li>
              <li className="text-gray-700 text-[16px] md:text-base">Certain medications</li>
              <li className="text-gray-700 text-[16px] md:text-base">Trauma to the teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Excessive fluoride exposure</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Temporary tooth sensitivity to hot and cold temperatures</li>
              <li className="text-gray-700 text-[16px] md:text-base">Mild gum irritation</li>
              <li className="text-gray-700 text-[16px] md:text-base">A brighter, whiter smile</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Practice good oral hygiene (brush twice daily, floss daily)</li>
              <li className="text-gray-700 text-[16px] md:text-base">Limit consumption of staining foods and beverages</li>
              <li className="text-gray-700 text-[16px] md:text-base">Avoid tobacco products</li>
              <li className="text-gray-700 text-[16px] md:text-base">Schedule regular dental cleanings</li>
              <li className="text-gray-700 text-[16px] md:text-base">Consider touch-up treatments as needed</li>
            </ul>
