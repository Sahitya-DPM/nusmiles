        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Prevent cavities and tooth decay</li>
              <li className="text-gray-700 text-[16px] md:text-base">Prevent gum disease (gingivitis and periodontitis)</li>
              <li className="text-gray-700 text-[16px] md:text-base">Remove surface stains and brighten your smile</li>
              <li className="text-gray-700 text-[16px] md:text-base">Detect oral health problems early</li>
              <li className="text-gray-700 text-[16px] md:text-base">Maintain fresh breath</li>
              <li className="text-gray-700 text-[16px] md:text-base">Improve overall health (oral health is linked to heart health)</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Those with gum disease</li>
              <li className="text-gray-700 text-[16px] md:text-base">People with a history of frequent cavities</li>
              <li className="text-gray-700 text-[16px] md:text-base">Individuals with certain medical conditions</li>
              <li className="text-gray-700 text-[16px] md:text-base">Smokers</li>
              <li className="text-gray-700 text-[16px] md:text-base">Pregnant women</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Brush your teeth twice daily with fluoride toothpaste</li>
              <li className="text-gray-700 text-[16px] md:text-base">Floss daily to remove plaque between teeth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Use an antiseptic mouthwash to kill bacteria</li>
              <li className="text-gray-700 text-[16px] md:text-base">Limit sugary foods and beverages</li>
              <li className="text-gray-700 text-[16px] md:text-base">Replace your toothbrush every 3-4 months</li>
              <li className="text-gray-700 text-[16px] md:text-base">Consider using an electric toothbrush for more effective cleaning</li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-[16px] text-gray-600 mb-4" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                Periodontal therapy treats gum disease and helps restore gum health to prevent tooth loss and other complications.
              </p>
              <Link 
      ...
      <section className="py-10 md:py-20 bg-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[16px] md:text-[16px] text-white/90 mb-8 max-w-2xl mx-auto" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
            Schedule your professional dental cleaning with Dr. Parikh to maintain optimal oral health and prevent dental problems.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/appointment" className="bg-white text-primary px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg inline-block" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              Schedule Cleaning
            </Link>
            <a href="tel:+12099551800" className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-primary transition-colors inline-block" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              Call (209) 955-1800
            </a>
          </div>
        </div>
