        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
              <li className="text-gray-700 text-[16px] md:text-base">Poor oral hygiene</li>
              <li className="text-gray-700 text-[16px] md:text-base">Gum disease</li>
              <li className="text-gray-700 text-[16px] md:text-base">Tooth decay</li>
              <li className="text-gray-700 text-[16px] md:text-base">Dry mouth</li>
              <li className="text-gray-700 text-[16px] md:text-base">Certain foods and beverages</li>
              <li className="text-gray-700 text-[16px] md:text-base">Tobacco use</li>
