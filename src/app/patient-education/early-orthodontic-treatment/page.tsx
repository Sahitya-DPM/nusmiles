          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Prevents more serious problems from developing</li>
                <li className="text-gray-700 text-[16px] md:text-base">May make treatment at a later age shorter and less complicated</li>
                <li className="text-gray-700 text-[16px] md:text-base">Guides jaw growth and development</li>
                <li className="text-gray-700 text-[16px] md:text-base">Creates space for permanent teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Reduces the need for tooth extractions</li>
                <li className="text-gray-700 text-[16px] md:text-base">Improves facial appearance</li>
                <li className="text-gray-700 text-[16px] md:text-base">Corrects harmful oral habits</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Severe crowding or spacing issues</li>
                <li className="text-gray-700 text-[16px] md:text-base">Crossbites, overbites, or underbites</li>
                <li className="text-gray-700 text-[16px] md:text-base">Protruding front teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Harmful oral habits like thumb sucking</li>
                <li className="text-gray-700 text-[16px] md:text-base">Jaw growth problems</li>
                <li className="text-gray-700 text-[16px] md:text-base">Difficulty chewing or speaking</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Palatal expanders to widen the upper jaw</li>
                <li className="text-gray-700 text-[16px] md:text-base">Space maintainers to hold space for permanent teeth</li>
                <li className="text-gray-700 text-[16px] md:text-base">Partial braces to correct specific problems</li>
                <li className="text-gray-700 text-[16px] md:text-base">Habit appliances to stop thumb sucking</li>
                <li className="text-gray-700 text-[16px] md:text-base">Functional appliances to guide jaw growth</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Comprehensive evaluation and diagnosis</li>
                <li className="text-gray-700 text-[16px] md:text-base">Customized treatment plan</li>
                <li className="text-gray-700 text-[16px] md:text-base">Active treatment phase (6-18 months)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Retention phase to maintain results</li>
                <li className="text-gray-700 text-[16px] md:text-base">Monitoring until all permanent teeth erupt</li>
              </ul>
            </div>
            ...
            <div className="bg-blue-50 rounded-xl p-8 mb-12">
              ...
              <p className="text-lg md:text-[16px] leading-relaxed text-gray-700" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
