          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Unilateral cleft lip (one side)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Bilateral cleft lip (both sides)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Complete or incomplete cleft</li>
                <li className="text-gray-700 text-[16px] md:text-base">May affect the nose and gum line</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Hard palate cleft (front part of roof of mouth)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Soft palate cleft (back part of roof of mouth)</li>
                <li className="text-gray-700 text-[16px] md:text-base">Complete or incomplete cleft</li>
                <li className="text-gray-700 text-[16px] md:text-base">May affect speech and feeding</li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Maternal smoking during pregnancy</li>
                <li className="text-gray-700 text-[16px] md:text-base">Alcohol consumption during pregnancy</li>
                <li className="text-gray-700 text-[16px] md:text-base">Certain medications taken during pregnancy</li>
                <li className="text-gray-700 text-[16px] md:text-base">Maternal diabetes</li>
                <li className="text-gray-700 text-[16px] md:text-base">Folic acid deficiency</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Specialized feeding techniques</li>
                <li className="text-gray-700 text-[16px] md:text-base">Nasoalveolar molding (NAM) if needed</li>
                <li className="text-gray-700 text-[16px] md:text-base">Initial evaluation by cleft team</li>
                <li className="text-gray-700 text-[16px] md:text-base">Treatment planning</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Cleft lip repair surgery</li>
                <li className="text-gray-700 text-[16px] md:text-base">May include nose reconstruction</li>
                <li className="text-gray-700 text-[16px] md:text-base">Post-operative care and monitoring</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Cleft palate repair surgery</li>
                <li className="text-gray-700 text-[16px] md:text-base">Speech development support</li>
                <li className="text-gray-700 text-[16px] md:text-base">Continued monitoring</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Speech therapy</li>
                <li className="text-gray-700 text-[16px] md:text-base">Dental and orthodontic treatment</li>
                <li className="text-gray-700 text-[16px] md:text-base">Additional surgeries as needed</li>
                <li className="text-gray-700 text-[16px] md:text-base">Regular follow-up with cleft team</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Close the gap in the lip</li>
                <li className="text-gray-700 text-[16px] md:text-base">Repair the muscle structure</li>
                <li className="text-gray-700 text-[16px] md:text-base">Improve the appearance of the nose</li>
                <li className="text-gray-700 text-[16px] md:text-base">Create a more normal lip contour</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Closing the gap in the palate</li>
                <li className="text-gray-700 text-[16px] md:text-base">Repairing the soft palate muscles</li>
                <li className="text-gray-700 text-[16px] md:text-base">Creating a functional palate for speech</li>
                <li className="text-gray-700 text-[16px] md:text-base">Improving feeding ability</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Bone grafting for the gum line</li>
                <li className="text-gray-700 text-[16px] md:text-base">Nose revision surgery</li>
                <li className="text-gray-700 text-[16px] md:text-base">Speech surgery if needed</li>
            ...
            <div className="bg-blue-50 rounded-xl p-8 mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2" style={{ fontFamily: 'Hind, Arial, Helvetica, sans-serif' }}>
                <li className="text-gray-700 text-[16px] md:text-base">Develop normal speech and language skills</li>
                <li className="text-gray-700 text-[16px] md:text-base">Have good dental health and appearance</li>
                <li className="text-gray-700 text-[16px] md:text-base">Lead active, healthy lives</li>
                <li className="text-gray-700 text-[16px] md:text-base">Achieve their full potential</li>
                <li className="text-gray-700 text-[16px] md:text-base">Have positive self-esteem and confidence</li>
              </ul>
            </div>
          </div>
        </div>
